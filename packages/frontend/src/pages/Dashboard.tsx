      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-0">
        ...
        <div className="mb-4 flex flex-col md:flex-row md:items-end gap-4 mt-0">
          ...
          <input
              ref={inputRef}
            type="text"
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors duration-200 mt-0"
            placeholder={t('search')}
            value={search}
